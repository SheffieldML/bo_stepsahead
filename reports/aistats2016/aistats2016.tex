...
\item Together with this work, we deliver a open source Python code framework (link removed for blind review) containing a fully functional  implementation of the method useful to reproduce the results of this work and applicable in general global optimisation problems.
...
To study the validity of our approximation we choose a variety of functions with a variety of dimensions a defined in various domains. See Table \ref{}.
