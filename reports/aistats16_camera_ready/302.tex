...
\end{equation}
where the expectation is taken over the multivariate Gaussian distribution, with mean vector $\mu$ and covariance matrix $\Sigma$, that gives rise after marginalising the posterior distribution of the GP at $\future_{n}(\latentVector_*)$. Note that under a fixed $\future_{n}(\latentVector_*)$, it also holds that 
$
...
\begin{center}
\begin{tabular}{ccc}
      \addheight{\includegraphics[width=50mm]{1_ahead.pdf}} &
      \addheight{\includegraphics[width=50mm]{2_ahead.pdf}}  &
      \addheight{\includegraphics[width=50mm]{3_ahead.pdf}}\\
      \addheight{\includegraphics[width=50mm]{5_ahead.pdf}} &
      \addheight{\includegraphics[width=50mm]{10_ahead.pdf}}  &
      \addheight{\includegraphics[width=50mm]{20_ahead.pdf}}\\
