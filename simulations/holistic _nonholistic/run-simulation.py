...
for experiment in experiments:
    ...
    for k in range(NR):
        ...
        GLASSES_02 = GPyOptmsa.msa.GLASSES(f,bounds, X,Y) 
        GLASSES_03   = GPyOptmsa.msa.GLASSES(f,bounds, X,Y) 
        GLASSES_05   = GPyOptmsa.msa.GLASSES(f,bounds, X,Y)
        GLASSES_10   = GPyOptmsa.msa.GLASSES(f,bounds, X,Y)
        ...
        GLASSES_02.run_optimization(max_iter=max_iter_dim*input_dim,n_ahead=2)
        ...
        print k
        print 'GLASSES_03'
        GLASSES_03.run_optimization(max_iter=max_iter_dim*input_dim,n_ahead=3) 
        ...
        print k
        print 'GLASSES_05'
        GLASSES_05.run_optimization(max_iter=max_iter_dim*input_dim,n_ahead=5)  
        ...
        print k
        print 'GLASSES_10'
        GLASSES_10.run_optimization(max_iter=max_iter_dim*input_dim,n_ahead=10)  
...
results_mean = np.zeros((5,5))
results_min = np.zeros((5,5))
results_median = np.zeros((5,5))
...
methods = ['EL','GL-2','GL-3','GL-5','GL-10']
